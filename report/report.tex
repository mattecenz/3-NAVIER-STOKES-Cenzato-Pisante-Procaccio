...
\begin{figure}
    \centering    
    \subfloat[Velocity field]{\includegraphics[width=0.5\textwidth]{testcase11111.png}\label{fig:v_steady}}
    \hfill
    \subfloat[Pressure field]{\includegraphics[width=0.5\textwidth]{pressure_testcase11111.png}\label{fig:sub2}}
...
\begin{figure}
    \centering
    \subfloat[Drag coefficient]{\includegraphics[width=0.5\textwidth]{Cd_test2.png}\label{fig:Cd_2D_test2}}
    \hfill
    \subfloat[Lift coefficient]{\includegraphics[width=0.5\textwidth]{cl_test2.png}\label{fig:Cl_2D_test2}}
