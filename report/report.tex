...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Time creation Preconditioners.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Time solve.png}
...
\subsubsection{Test Cases unsteady 1}
...
\begin{figure}[h]
    ...
    \subfloat[Time taken to initialize the preconditioner at each time step.]{\includegraphics[width=0.5\textwidth]{time_prec.png}\label{fig:sub3}}
    \hfill
    \subfloat[Drag coefficient over time.]{\includegraphics[width=0.5\textwidth]{time_syst.png}\label{fig:sub2}}
\vspace{1em} % Spacing between the rows of images
    \subfloat[Drag coefficient over time.]{\includegraphics[width=0.5\textwidth]{drag_coeff.png}\label{fig:sub3}}
    \hfill
    \subfloat[Lift coefficient over time.]{\includegraphics[width=0.5\textwidth]{lift_coeff.png}\label{fig:sub2}}
\vspace{1em} % Spacing between the rows of images
\end{figure}
...
\begin{figure}[h]
    ...
    \subfloat[Velocity field in a coarse mesh.]{\includegraphics[width=0.4\textwidth]{velocity_coarse_4s.png}\label{fig:sub3}}
    \hfill
    \subfloat[Pressure field in a coarse mesh.]{\includegraphics[width=0.4\textwidth]{pressure_coarse_4s.png}\label{fig:sub2}}
    
    \vspace{1em} % Spacing between the rows of images
    
    \subfloat[Velocity field in a fine mesh.]{\includegraphics[width=0.4\textwidth]{velocity_fine_4s.png}\label{fig:sub3}}
    \hfill
    \subfloat[Pressure field in a fine mesh.]{\includegraphics[width=0.4\textwidth]{pressure_fine_4s.png}\label{fig:sub2}}
\end{figure}
\newpage
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{velocity_noconv_01s.png}
