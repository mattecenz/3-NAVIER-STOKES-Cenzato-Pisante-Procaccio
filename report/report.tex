...
\begin{figure}
\centering
 \subfloat[Drag coefficient]{\includegraphics[width=0.5\textwidth]{Cd_test1.jpg.png}\label{fig:Cd_2D_test1}}
    \hfill
    \subfloat[Lift coefficient]{\includegraphics[width=0.5\textwidth]{CL_test1.jpg}\label{fig:Cl_2D_test2}}
...
\begin{figure}
    \centering    
    \subfloat[Velocity at time t=0.001s]{\includegraphics[width=0.5\textwidth]{testcase11111.png}\label{fig:v_steady}}
    \hfill
    \subfloat[Pressure at time t=0.001s]{\includegraphics[width=0.5\textwidth]{pressure_testcase11111.png}\label{fig:sub2}}
...
\begin{figure}
    \centering
     \subfloat[Drag coefficient]{\includegraphics[width=0.5\textwidth]{Cd_test2.jpg.png}\label{fig:Cd_2D_test2}}
    \hfill
    \subfloat[Lift coefficient]{\includegraphics[width=0.5\textwidth]{cl_test2.jpg.png}\label{fig:Cl_2D_test2}}
...
\begin{figure}
    \centering    
    \subfloat[Velocity at time t=0.001s]{\includegraphics[width=0.5\textwidth]{velocity_2D_test2_ts1.png}\label{fig:sub3}}
    \hfill
...
This sequence of images shows the reason why this test cannot be considered stationary: the static initial condition combined with a high Reynolds number \(Re\) implies a strong effect of the time derivative \frac{\partial u}{\partial t} on the system_matrix.
Notably, the symmetry of the inlet velocity, bluff body and boundary condition implies almost symmetric velocity and pressure fields with respect to the \(x\)-axis.
...
Finally, Velocity and pressure transition over time are shown in the groups of figures~\ref{fig:P_V_test3} below:
...
\centering
    ...
    \subfloat[pressure at time t=7.0s]{\includegraphics[width=0.5\textwidth]{ptime1400.png}\label{fig:sub2}}
        ...
        \subfloat[velocity at time t=7.0s]{\includegraphics[width=0.5\textwidth]{vtime1601.png}}\label{fig:sub3}}
    \hfill
    \subfloat[pressure at time t=7.0s]{\includegraphics[width=0.5\textwidth]{ptime1601.png}}\label{fig:sub2}}
